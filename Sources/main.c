...
int main(int argc, char **argv)
{
    ...
    //commande--->  ./main transfLineaireSimple images/villeobscure.pgm images/villeClaire
    ...
    //commande--->  ./main transfLineaireSat images/port.pgm imagesRes/portClaire
    ...
    //commande--->  ./main filtreGaussien images/boulanger.pgm images/boulanGauss
    ...
    //commande--->  ./main laplacien4 images/cam.pgm images/lapla4Reg
    ...
    //commande--->  ./main laplacien8 images/cam.pgm images/lapla8Reg
    ...
    //commande--->  ./main binarisationOtsu images/empreinte.pgm images/IbinariseOtsu
    ...
    //commande--->  ./main binarisation images/empreinte.pgm images/Ibinarise
    ...
    else if(strcmp(argv[1], "hough_transform") == 0)
    {
        Tuple3 t;
        t = hough_transform(image,taillImg);
        makefile(t.image, t.nblig, t.nbcol, argc, argv);
    }
    //commande--->  ./main hough_transform images/cam.pgm images/HougTrans
